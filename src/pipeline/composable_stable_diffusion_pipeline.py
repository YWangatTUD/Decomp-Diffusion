...
class ComposableStableDiffusionPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        # 7. Denoising loop
        weights = torch.tensor([guidance_scale] * prompt_embeds.shape[1], device=self.device).reshape(-1, 1, 1, 1)
